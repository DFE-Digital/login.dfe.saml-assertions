...
describe("when using static assertion storage", () => {
  it("then it should return template", async () => {
    const actual = await staticAssertionsStorage.getById(
      "3bfde961-f061-4786-b618-618deaf96e44",
    );
  ...
  it("it should duplicate template to avoid singleton issues", async () => {
    const first = await staticAssertionsStorage.getById(
      "3bfde961-f061-4786-b618-618deaf96e44",
    );
    const second = await staticAssertionsStorage.getById(
      "3bfde961-f061-4786-b618-618deaf96e44",
    );
